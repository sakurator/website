...
class Game {
    ...
    #registerEvents() {
        this.optionEls.forEach((option) => {
            ...
            option.addEventListener("click", async (event) => {
                ...
                this.particles.splash(mousePosition, Math.round(this.combo * 1.33), this.combo * 50);
    ...
    async showCompletionResult() {
        ...
        this.particles.splash(createCenterPosition(), 30, 600);
    ...
    async congratulateWithRowCompletion() {
        ...
        for (let i = 0; i < 7; i++) {
            ...
            this.particles.splash(petalsPosition, 20, 800);
